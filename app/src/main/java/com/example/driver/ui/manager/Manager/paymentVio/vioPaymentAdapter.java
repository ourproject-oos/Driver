...
public class vioPaymentAdapter extends RecyclerView.Adapter {

    Context context;
    List<VioClass> vioClassList;

    public vioPaymentAdapter(Context context, List<VioClass> vioClassList) {
...
//        ((ViewHolder) holder).txtDate.setText("Vio Date: " +vioClass.getDate());
        ((ViewHolder) holder).btnPayVio.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                context.startActivity(intent);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            btnPayVio = itemView.findViewById(R.id.btn_payment_vio);
